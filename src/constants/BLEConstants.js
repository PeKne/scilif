...
export const DEVICE_DFU_NAME = "SunFibre-DFU";
...
export const SERVICE_DFU_ACTIVATION = "0000fe59-0000-1000-8000-00805f9b34fb";

export const DEVICE_SERVICES = [SERVICE_LED_CONTROL, SERVICE_MONITOR, SERVICE_RFID, SERVICE_DIS, SERVICE_DFU_ACTIVATION];
...
// DFU service
export const CHARACTERISTIC_DFU_BUTTONLESS = 0;
